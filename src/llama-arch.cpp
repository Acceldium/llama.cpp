...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_COHERE_ASR,       "cohere-asr"       },
    { LLM_ARCH_JAIS,             "jais"             },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ENCODER_EMBEDDING_LENGTH,          "%s.encoder.embedding_length"          },
    { LLM_KV_ENCODER_FEED_FORWARD_LENGTH,       "%s.encoder.feed_forward_length"       },
    { LLM_KV_ENCODER_ATTENTION_HEAD_COUNT,      "%s.encoder.attention.head_count"      },
    { LLM_KV_ENCODER_ATTENTION_KEY_LENGTH,      "%s.encoder.attention.key_length"      },
    { LLM_KV_ENCODER_ATTENTION_VALUE_LENGTH,    "%s.encoder.attention.value_length"    },
    { LLM_KV_ENCODER_CONV_KERNEL_SIZE,          "%s.encoder.conv_kernel_size"          },
    { LLM_KV_ENCODER_SUBSAMPLING_FACTOR,        "%s.encoder.subsampling_factor"        },
    { LLM_KV_ENCODER_SUBSAMPLING_CHANNELS,      "%s.encoder.subsampling_channels"      },
    { LLM_KV_ENCODER_FEATURES_COUNT,            "%s.encoder.features_count"            },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ENC_MEL_FB,                             "enc.mel_fb" },
    { LLM_TENSOR_ENC_MEL_WINDOW,                         "enc.mel_window" },
    { LLM_TENSOR_ENC_SUBSAMPLE_CONV,                     "enc.subsample.%d.conv" },
    { LLM_TENSOR_ENC_SUBSAMPLE_OUT,                      "enc.subsample.out" },
    { LLM_TENSOR_ENC_FFN1_NORM,                          "enc.blk.%d.ffn1_norm" },
    { LLM_TENSOR_ENC_FFN1_UP,                            "enc.blk.%d.ffn1_up" },
    { LLM_TENSOR_ENC_FFN1_DOWN,                          "enc.blk.%d.ffn1_down" },
    { LLM_TENSOR_ENC_ATTN_POS,                           "enc.blk.%d.attn_pos" },
    { LLM_TENSOR_ENC_ATTN_POS_BIAS_U,                    "enc.blk.%d.attn_pos_bias_u" },
    { LLM_TENSOR_ENC_ATTN_POS_BIAS_V,                    "enc.blk.%d.attn_pos_bias_v" },
    { LLM_TENSOR_ENC_CONV_LN,                            "enc.blk.%d.conv_ln" },
    { LLM_TENSOR_ENC_CONV_PW1,                           "enc.blk.%d.conv_pw1" },
    { LLM_TENSOR_ENC_CONV_DW,                            "enc.blk.%d.conv_dw" },
    { LLM_TENSOR_ENC_CONV_BN,                            "enc.blk.%d.conv_bn" },
    { LLM_TENSOR_ENC_CONV_PW2,                           "enc.blk.%d.conv_pw2" },
    { LLM_TENSOR_ENC_NORM_OUT,                           "enc.blk.%d.norm_out" },
    { LLM_TENSOR_ENC_OUTPUT_PROJ,                        "enc.output_proj" },
    { LLM_TENSOR_DEC_EMBD_NORM,                          "dec.embd_norm" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ENC_MEL_FB,                 {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ENC_MEL_WINDOW,             {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL}},
    {LLM_TENSOR_ENC_SUBSAMPLE_CONV,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
    {LLM_TENSOR_ENC_SUBSAMPLE_OUT,          {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ENC_FFN1_NORM,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ENC_FFN1_UP,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ENC_FFN1_DOWN,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ENC_ATTN_POS,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ENC_ATTN_POS_BIAS_U,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_ENC_ATTN_POS_BIAS_V,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_ENC_CONV_LN,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ENC_CONV_PW1,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ENC_CONV_DW,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_SSM_CONV}},
    {LLM_TENSOR_ENC_CONV_BN,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ENC_CONV_PW2,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ENC_NORM_OUT,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ENC_OUTPUT_PROJ,            {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DEC_EMBD_NORM,              {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL}},
