...
enum llm_kv {
    ...
    LLM_KV_ENCODER_EMBEDDING_LENGTH,
    LLM_KV_ENCODER_FEED_FORWARD_LENGTH,
    LLM_KV_ENCODER_ATTENTION_HEAD_COUNT,
    LLM_KV_ENCODER_ATTENTION_KEY_LENGTH,
    LLM_KV_ENCODER_ATTENTION_VALUE_LENGTH,
    LLM_KV_ENCODER_CONV_KERNEL_SIZE,
    LLM_KV_ENCODER_SUBSAMPLING_FACTOR,
    LLM_KV_ENCODER_SUBSAMPLING_CHANNELS,
    LLM_KV_ENCODER_FEATURES_COUNT,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ENC_MEL_FB,
    LLM_TENSOR_ENC_MEL_WINDOW,
    LLM_TENSOR_ENC_SUBSAMPLE_CONV,
    LLM_TENSOR_ENC_SUBSAMPLE_OUT,
    LLM_TENSOR_ENC_FFN1_NORM,
    LLM_TENSOR_ENC_FFN1_UP,
    LLM_TENSOR_ENC_FFN1_DOWN,
    LLM_TENSOR_ENC_ATTN_POS,
    LLM_TENSOR_ENC_ATTN_POS_BIAS_U,
    LLM_TENSOR_ENC_ATTN_POS_BIAS_V,
    LLM_TENSOR_ENC_CONV_LN,
    LLM_TENSOR_ENC_CONV_PW1,
    LLM_TENSOR_ENC_CONV_DW,
    LLM_TENSOR_ENC_CONV_BN,
    LLM_TENSOR_ENC_CONV_PW2,
    LLM_TENSOR_ENC_NORM_OUT,
    LLM_TENSOR_ENC_OUTPUT_PROJ, // encoder_decoder_proj: n_embd_enc -> n_embd
    // Cohere-asr decoder embedding norm (LN applied once after token+pos sum)
    LLM_TENSOR_DEC_EMBD_NORM,
    LLM_TENSOR_CLS,
    LLM_TENSOR_CLS_OUT,
    LLM_TENSOR_CLS_NORM,
    LLM_TENSOR_CONV1D,
